...
def create_and_upload_env(coin, symbol, initial_capital, max_pos_size):
    content = env_content
...
# Deploy .env copies
create_and_upload_env('btc', 'BTC/USDT:USDT', '30', '0.001')
create_and_upload_env('sol', 'SOL/USDT:USDT', '30', '0.5')
sftp.close()
...
ssh.exec_command("systemctl enable bitget-bot-btc bitget-bot-sol")
ssh.exec_command("systemctl start bitget-bot-btc bitget-bot-sol")
